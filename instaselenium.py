...
class Bot():
    ...
    def login(self, username, password):
        ...
        self.driver.find_element_by_xpath("//button[contains(text(), 'Akceptuję wszystko')]").click()
        sleep(5)
    ...
    def likehashtag(self, hashtag):
        ...
        for link in self.links:
            ...
            # sleep(1)
            # self.driver.find_element_by_xpath("//textarea[@placeholder='Dodaj komentarz...']").send_keys(self.comments[randint(0,1)])
            # sleep(1)
